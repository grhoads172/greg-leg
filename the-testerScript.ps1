...
&"C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\" "$directPath/Tests/Tests.sln" /property:Configuration=Release /p:Version=$version
