...
&"C:/Program Files/Microsoft Visual Studio/2022/Enterprise/MSBuild/Current/Bin/MSBuild.exe" "$directPath/Tests/Tests.sln" /property:Configuration=Release /p:Version=$version
