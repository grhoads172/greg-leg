...
&"C:/Program Files/Microsoft Visual Studio/2022/Enterprise/MSBuild/Current/Bin/MSBuild.exe" "C:/Users/rhoadg/Documents/GitHub/greg-leg/Tests/the_tester/the_tester.csproj" /property:Configuration=Release /p:Version=$version

&"C:/Program Files (x86)/Inno Setup 6/ISCC.exe" "C:/Users/rhoadg/Documents/GitHub/greg-leg/test-setup.iss"
